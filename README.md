...
4. Select the `extension_dist` directory (generated by `npm run build` or extracted from `octodeck-extension-*.zip` from [Releases](https://github.com/tallclair/octodeck/releases)).
